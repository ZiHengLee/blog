...
const LayoutBase = props => {
  console.log('fuckkkin LayoutBase')
  const { post, children, slotTop, className } = props
  const { onLoading, fullWidth } = useGlobal()
  console.log('fuckkk', post, children)
...
const LayoutIndex = props => {
  console.log('fuckkkin LayoutIndex')
...
const LayoutPostList = props => {
  console.log('fuckkkin LayoutPostList')
  return (
    <div className="pt-8">
      <SlotBar {...props} />
...
const LayoutSearch = props => {
  console.log('fuckkkin LayoutSearch')
  const { keyword } = props
  const router = useRouter()
...
const LayoutArchive = props => {
  console.log('fuckkkin LayoutArchive')
...
const LayoutSlug = props => {
  console.log('fuckkkin LayoutSlug')
...
const Layout404 = props => {
  console.log('fuckkkin Layout404')
  const router = useRouter()
  useEffect(() => {
    // 延时3秒如果加载失败就返回首页
    setTimeout(() => {
...
const LayoutCategoryIndex = props => {
  console.log('fuckkkin LayoutCategoryIndex')
...
const LayoutTagIndex = props => {
  console.log('fuckkkin LayoutTagIndex')
